...
\begin{enumerate}
    ...
    \item Editar datos de las bibliotecas. Crear, eliminar y editar datos de las bibliotecas.
...
En primer lugar descargamos los datos de la página oficial de Datos Abiertos. La descarga RDF está en formato RDF/XML, pero 
