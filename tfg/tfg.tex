...
\begin{enumerate}
    ...
    \item A través de Django REST Framework, un componente independiente pero altamente acoplado al framework Django
\end{enumerate}
...
\req{un entorno con una ruta X con contenido estático en base64}
{accedemos a la ruta X}
